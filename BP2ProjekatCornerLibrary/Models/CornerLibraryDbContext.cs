...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		{
			entity.HasKey(e => new { e.Idik, e.Idknjiga }).HasName("IKK_PK");
		...
		{
			entity.HasKey(e => new { e.Idik, e.Idsstivo }).HasName("IZDS_PK");
		...
		{
			entity.HasKey(e => new { e.Idautor, e.Idknjiga }).HasName("PIS_PK");
        ...
        modelBuilder.Entity<Knjiga>(entity =>
        {
            ...
            entity.Property(e => e.Idknjiga)
                .ValueGeneratedNever()
                .HasColumnName("IDKnjiga");
            entity.Property(e => e.GodIzd).HasMaxLength(50).IsUnicode(true);
