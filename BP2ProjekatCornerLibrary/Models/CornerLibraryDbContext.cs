...
public partial class CornerLibraryDbContext : DbContext
{
    ...
    public virtual DbSet<Izdajesstivo> Izdajesstivos { get; set; }

    public virtual DbSet<Knjiganajeziku> Knjiganajezikus { get; set; }

    public virtual DbSet<Mestoudrzavi> Mestoudrzavis { get; set; }

    public virtual DbSet<Pise> Pises { get; set; }

    public virtual DbSet<Pripadazanru> Pripadazanrus { get; set; }

    public virtual DbSet<Sstivonajeziku> Sstivonajezikus { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		// //         entity.HasOne(d => d.IdknjigaNavigation).WithMany(p => (IEnumerable<Pise>)p.Idautors).HasForeignKey(d => d.Idknjiga).HasConstraintName("PIS_FK1");

		//	//entity.HasOne(d => d.IdautorNavigation).WithMany(p => (IEnumerable<Pise>)p.Idknjigas).HasForeignKey(d => d.Idknjiga).HasConstraintName("PIS_FK2");
		//});
        ...
        modelBuilder.Entity<Izdajesstivo>(entity =>
        {
            entity.HasKey(e => new { e.Idsstivo, e.Idik }).HasName("IZDS_PK");

            entity.ToTable("IZDAJESSTIVO");
        ...
        modelBuilder.Entity<Mestoudrzavi>(entity =>
        {
            entity.HasKey(e => new { e.PosBr, e.Oznd }).HasName("MUD_PK");

            entity.ToTable("MESTOUDRZAVI");
        ...
        modelBuilder.Entity<Sstivonajeziku>(entity =>
        {
            entity.HasKey(e => new { e.Idsstivo, e.Oznj }).HasName("SSNJ_PK");

            entity.ToTable("SSTIVONAJEZIKU");
