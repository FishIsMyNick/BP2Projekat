...
DELETE FROM ISPUNJENZAHTEVZAKNJIGU;
DELETE FROM CLANZAHTEVAKNJIGU;
DELETE FROM CLANZAHTEVANOVINE;
DELETE FROM CLANZAHTEVAMAGAZIN;
DELETE FROM ISTORIJAREZERVACIJA;
DELETE FROM ZAHTEVZAKNJIGU;
DELETE FROM ZAHTEVZANOVINE;
DELETE FROM ZAHTEVZAMAGAZIN;
DELETE FROM CLAN;
DELETE FROM KNJIGA;
DELETE FROM NOVINE;
DELETE FROM MAGAZIN;
DELETE FROM BIBLIOTEKAR;
delete from cornerlibrary;
...
INSERT INTO CLAN (ID, Username, Pass, Ime, Prezime, DatRodj, Kredit, Tip)
VALUES
    (1, 'Fish', 'd74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1', 'Luka', 'Miletic', '1997-11-15', 500.0, 1),
